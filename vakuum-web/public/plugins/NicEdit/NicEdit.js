...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath: NicEdit_icon_path + 'nicEditorIcons.gif',
...
var nicUploadOptions = {
	...
	iconFiles: {
		'upload': NicEdit_icon_path + 'upload.gif'
	}
};

var nicUploadButton = nicEditorAdvancedButton.extend({
	nicURI: NicEdit_upload,
	addPane: function() {
		this.im = this.ne.selectedInstance.selElm().parentTag('IMG');
	...
	addForm: function() {
		...
		myDoc.write('<div style="font-size: 14px; font-weight: bold; padding-top: 5px;">上传图片</div>');
	...
	startUpload: function() {
		...
		this.myStatus.setContent('<img src="'+ NicEdit_icon_path +'ajax-loader.gif" style="float: right; margin-right: 40px;" /><strong>Uploading...</strong><br />Please wait');
		this.myForm.submit();
